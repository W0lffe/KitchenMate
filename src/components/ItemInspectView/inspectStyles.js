...
export const topSection = `h-1/6 flex flex-col justify-center p-5 border-b-1 border-white/50 rounded-custom`;

export const bottomSection =  `h-5/6 flex flex-col lg:flex-row`;

export const listSection = `flex flex-col items-center h-1/2 lg:h-full w-full border-b-1 border-white/50 lg:border-0 rounded-custom`;
...
export const iconSpan = `flex flex-row justify-end items-center gap-6 mt-2`;
