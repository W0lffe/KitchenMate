...
export const containerStyle = `fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 
                            bg-white text-black max-h-fit gap-5 flex flex-col 
                            p-10 border-2 border-black rounded-custom-med gap-10`;

export const headerStyle = `flex w-full justify-end text-xl`;
