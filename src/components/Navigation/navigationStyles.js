...
export const topStyle = `flex flex-col w-full justify-center items-end p-5 hover:italic hover:animate-pulse`

export const getSectionStyle = (state) => {
    let style  = `flex flex-col w-full h-fit justify-center items-center p-2 lg:p-5
