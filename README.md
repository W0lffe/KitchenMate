...
1. <ins>On some browsers, the site may fail to load or behave unexpectedly due to issues with session authentication handling.  
   ...
   - Will look into switching to token-based authentication in the future. </ins>
